/*
 * MediaDropTarget.java
 *    This clas handles drops of media objects
 *
 *   @author  HarveyD
...
/** Handle drops of audio, video, and picture files */
public class MediaDropTarget implements DropTargetListener
{  Method mediaDroppedMethod, mediaIsMediaMethod;
   Object dropObject;

   public MediaDropTarget(Container component, Object dropObject)
   ...
   public void drop(DropTargetDropEvent dtde)
    {   dtde.acceptDrop(DnDConstants.ACTION_COPY_OR_MOVE);
        ...
        if (files==null || files.length==0 || !acceptIt(dtde.getTransferable()))
        ...
        {  if (listFlavor!=null)
           {   list = (AbstractList<?>)transfer.getTransferData(listFlavor);
               ...
               {  file[i] = (File)list.get(i);
                  ...
                  try
                  {  Boolean flag =
                        (Boolean)mediaIsMediaMethod.invoke(dropObject, file[i]);
                     if (!flag.booleanValue()) return null;
                  }
